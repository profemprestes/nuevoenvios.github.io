...
interface CourierTableProps {
  solicitudes: MensajeriaRequestData[];
  onViewDetails: (solicitud: MensajeriaRequestData) => void;
  onEdit: (solicitud: MensajeriaRequestData) => void;
      ...
      <TableBody>
        {solicitudes.map((solicitud) => (
          <TableRow key={solicitud.id}>
            ...
            <TableCell className="truncate max-w-xs">{solicitud.origen}</TableCell>
            ...
            <TableCell className="hidden lg:table-cell">
              {formatTimestampForDisplay(solicitud.fechaRecoleccionDeseada)}
            </TableCell>
            <TableCell>
              <span
